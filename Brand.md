...
The brand reads as a real, restrained fashion imprint — but everything it produces is generated. That tension is never announced on the surface. It's discovered.
...
**One line:** *A fashion house run by a designer, built on a pipeline.*
...
- **Unisex, neutral address.** Speaks to a person, not a demographic. No gendered cheerleading.

**Sounds like:** "Crafted in soft fleece. Colour-blocked. Cut to sit close." 
**Never sounds like:** "You'll LOVE this cosy must-have vest — grab yours before it's gone!"
...
**Product naming:** Plain, descriptive, capitalised. The garment names itself by what it is.
- `BLOCKED FLEECE VEST`
- `TECHNICAL SHELL`
- `RIBBED KNIT CREW`

No cute names, no collection theatrics. The descriptor *is* the name.

**Categories:** MEN / WOMEN / ARCHIVE. "Archive" rather than "Sale" or "Past Seasons" — it frames everything as catalogue, not clearance.
...
The brand's defining move is restraint about its own nature. The storefront makes no claim about being AI-generated on first read — it earns belief first. The disclosure, when it comes, is a single quiet line, set in the same micro-caps as everything else:

> EVERY IMAGE IN THIS HOUSE WAS GENERATED.

Stated once, without drama, in the brand's own flat editorial register. The whole point lands harder *because* it's said quietly.

---

## What the Brand Is Not

- Not playful or punny.
- Not influencer-voiced or trend-chasing.
- Not loud about technology — the pipeline is the engine, not the marketing.
- Not over-designed. The label signs the work and steps back.

---

## Principles

1. **The name signs the work — it doesn't shout it.**
2. **State, don't sell.** Fact and fabric over adjectives and urgency.
3. **Quiet is the flex.** Confidence reads through restraint.
4. **The system stays backstage.** The label is a fashion house first; the pipeline is how it's built, revealed only when it counts.
5. **Belief before reveal.** Earn it as real, then disclose it's generated.